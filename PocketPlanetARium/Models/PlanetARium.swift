...
//        let scaleValueAtMax: Bool = scaleValue >= scaleMaximum
        ...
        return ("Sun to \(planetName): \(distanceInFeet)", sweetSpotReached(for: scaleValue) ? UIColor.colorIcyBlue : .white)
    }
    ...
    private func addPlanets(earthRadius: Float, earthDistance: Float, earthDay: TimeInterval, earthYear: TimeInterval) {
        ...
        addPlanetHelper(name: "Mercury",
                        ...
                        orbitalCenterTilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(7)),
        ...
        addPlanetHelper(name: "Venus",
                        ...
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(177)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 0.72),
                        rotationSpeed: earthDay * 243,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(25), z: K.Math.degToRad(3.4)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Earth",
                        type: PlanetType.planet,
                        radius: earthRadius,
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(23)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance),
                        rotationSpeed: earthDay,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(50), z: 0),
                        orbitalCenterPosition: sun.getNode().position,
...
//            earth.addSpecular(imageFileName: "earth_specular")
            ...
            addPlanetHelper(name: "Moon",
                          ...
                          tilt: moonCheck == nil ? SCNVector3(x: 0, y: .pi, z: K.Math.degToRad(5.9)) : moonCheck!.getNode().eulerAngles,
                          position: SCNVector3(0, 0, earthRadius + earthRadius * 0.5),
                          rotationSpeed: 9999,
                          orbitalCenterTilt: moonCheck == nil ? SCNVector3(x: 0, y:0, z: K.Math.degToRad(5.1)) : moonCheck!.getOrbitalCenterNode().eulerAngles,
        ...
        addPlanetHelper(name: "Mars",
                        ...
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(25)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 1.52),
                        rotationSpeed: earthDay * 1.04,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(70), z: K.Math.degToRad(1.9)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Jupiter",
                        ...
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(3)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 5.2),
                        rotationSpeed: earthDay * 0.42,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(100), z: K.Math.degToRad(1.3)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Saturn",
                        ...
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(27)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 9.58),
                        rotationSpeed: earthDay * 0.46,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(150), z: K.Math.degToRad(2.5)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Uranus",
                        ...
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(98)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 19.18),
                        rotationSpeed: earthDay * 0.71,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(180), z: K.Math.degToRad(0.8)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Neptune",
                        ...
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(195), z: K.Math.degToRad(1.8)),
                        orbitalCenterPosition: sun.getNode().position,
        ...
        addPlanetHelper(name: "Pluto",
                        type: PlanetType.planet,
                        radius: earthRadius,
                        tilt: SCNVector3(x: 0, y: 0, z: K.Math.degToRad(122)),
                        position: SCNVector3(x: 0, y: 0, z: earthDistance * 39.48),
                        rotationSpeed: earthDay * 6.38,
                        orbitalCenterTilt: SCNVector3(x: 0, y: -K.Math.degToRad(200), z: K.Math.degToRad(17.2)),
                        orbitalCenterPosition: sun.getNode().position,
