...
//    var planets: [String: Planet] = [:]
    ...
    mutating func addPlanets(earthRadius: Float, earthDistance: Float, earthDay: TimeInterval, earthYear: TimeInterval) {
        ...
        sun.addParticles()
        addPlanetHelper(with: sun)
//        planetGroup.addPlanet(sun)
